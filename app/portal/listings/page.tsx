...
async function getListings(params: Record<string, string | undefined>) {
  ...
  return {
    listings: listings.map((l) => ({ ...l, agent: agentMap[l.user_id] || null })),
    total: count || 0,
    page,
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      >
        <input
          ...
          className="px-3 py-2 rounded-lg bg-white/[0.06] border border-white/[0.08] text-sm text-white placeholder:text-white/30 w-32 focus:outline-none focus:border-cyan-400/40"
        />
        <input
          type="text"
          name="state"
          ...
          className="px-3 py-2 rounded-lg bg-white/[0.06] border border-white/[0.08] text-sm text-white placeholder:text-white/30 w-24 focus:outline-none focus:border-cyan-400/40"
        />
        <input
          type="number"
          name="beds"
          ...
          className="px-3 py-2 rounded-lg bg-white/[0.06] border border-white/[0.08] text-sm text-white placeholder:text-white/30 w-20 focus:outline-none focus:border-cyan-400/40"
        />
        <input
          type="number"
          name="baths"
        ...
        <input
          ...
          className="px-3 py-2 rounded-lg bg-white/[0.06] border border-white/[0.08] text-sm text-white placeholder:text-white/30 w-28 focus:outline-none focus:border-cyan-400/40"
        />
        <input
          type="number"
          name="maxPrice"
        ...
        {activeFilters.length > 0 && (
          <Link
            href="/listings"
            className="px-4 py-2 rounded-lg border border-white/[0.08] text-white/40 hover:text-white/60 text-sm transition-all"
          >
            Clear
          </Link>
        )}
      ...
      {activeFilters.length > 0 && (
        <div className="flex flex-wrap gap-2 mb-4">
          {activeFilters.map((f) => (
            <span
              key={f}
              className="px-2.5 py-1 rounded-md bg-cyan-500/10 text-cyan-400 text-xs font-medium"
            >
              {f}
            </span>
          ))}
        ...
        <div className="mt-8 flex items-center justify-center gap-2">
          {page > 1 && (
            <Link
              ...
              className="p-2 rounded-lg border border-white/[0.08] text-white/40 hover:text-white hover:border-white/20 transition-all"
            >
