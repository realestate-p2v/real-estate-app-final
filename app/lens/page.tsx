          ...
          <div className="text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
              {isSubscriber ? (
                ...
                <Button onClick={() => document.getElementById("pricing")?.scrollIntoView({ behavior: "smooth" })} className="group bg-gradient-to-r from-cyan-400 to-blue-500 hover:from-cyan-300 hover:to-blue-400 text-white font-black h-16 px-12 text-xl rounded-2xl shadow-2xl shadow-cyan-500/40 hover:scale-[1.03] hover:shadow-cyan-400/60 transition-all">
                  See our AI Tools plans <ArrowRight className="ml-2.5 h-6 w-6 transition-transform group-hover:translate-x-1" />
                </Button>
              )}
            </div>
          </div>
