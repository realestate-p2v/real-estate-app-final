...
const TEMPLATES=[{id:"just-listed",label:"Just Listed",icon:Home,color:"#10b981"},{id:"magazine-cover",label:"Listed (Magazine)",icon:Home,color:"#0ea5e9"},{id:"stamp-listed",label:"Listed (Stamp)",icon:Home,color:"#14b8a6"},{id:"cinematic-listed",label:"Listed (Cinema)",icon:Home,color:"#6366f1"},{id:"for-rent",label:"For Rent",icon:Home,color:"#16a34a"},{id:"magazine-rent",label:"Rent (Magazine)",icon:Home,color:"#16a34a"},{id:"stamp-rent",label:"Rent (Stamp)",icon:Home,color:"#16a34a"},{id:"cinematic-rent",label:"Rent (Cinema)",icon:Home,color:"#16a34a"},{id:"frame-rent",label:"Rent (Frame)",icon:Home,color:"#16a34a"},{id:"price-reduced",label:"Price Reduced",icon:DollarSign,color:"#f59e0b"},{id:"stamp-reduced",label:"Reduced (Stamp)",icon:DollarSign,color:"#f97316"},{id:"cinematic-reduced",label:"Reduced (Cinema)",icon:DollarSign,color:"#e11d48"},{id:"bold-frame",label:"Reduced (Frame)",icon:DollarSign,color:"#dc2626"},{id:"just-sold",label:"Just Sold",icon:CheckCircle,color:"#ef4444"},{id:"open-house",label:"Open House",icon:Calendar,color:"#6366f1"}];
