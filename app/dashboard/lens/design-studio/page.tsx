    ...
    try {
      ...
      if (hasMusic) {
        ...
        await ffmpeg.exec([
          ...
          "-filter_complex",
          [
            `[0:v]scale=${outW}:-2[scaled]`,
            `color=black:${outW}x${outH}:d=1[base]`,
            `[base][scaled]overlay=0:0:shortest=1[bg]`,
        ...
        await ffmpeg.exec([
          ...
          "-i", "overlay.png",
          "-t", "45",
          "-filter_complex", `[0:v]scale=${outW}:-2[scaled];color=black:${outW}x${outH}:d=1[base];[base][scaled]overlay=0:0:shortest=1[bg];[bg][1:v]overlay=0:0`,
          "-c:v", "libx264",
          "-preset", "fast",
          "-crf", "23",
          "-c:a", "aac",
