...
function MagazineCoverTemplate({size,listingPhoto,videoElement,headshot,address,addressLine2,beds,baths,sqft,price,agentName,phone,brokerage,logo,fontFamily,barColor,accentColor,brandShadow}:any){
  const w=size.width,h=size.height,isStory=size.id==="story",isPostcard=size.id==="postcard",unit=w/1080;
...
function SplitDiagonalTemplate({size,listingPhoto,videoElement,headshot,address,addressLine2,beds,baths,sqft,price,agentName,phone,brokerage,logo,fontFamily,barColor,accentColor,brandShadow}:any){
  const w=size.width,h=size.height,isStory=size.id==="story",isPostcard=size.id==="postcard",unit=w/1080;
  ...
  const brandFs=Math.round((isStory?40:isPostcard?28:24)*unit);
...
function CinematicTemplate({size,listingPhoto,videoElement,headshot,badgeText,badgeColor,address,addressLine2,beds,baths,sqft,price,agentName,phone,brokerage,logo,fontFamily,barColor,accentColor,brandShadow}:any){
  ...
  const brandFs=Math.round((isStory?36:isPostcard?26:22)*unit);
...
// ─── BoldFrameTemplate ───────────────────────────────────────────────────────
function BoldFrameTemplate({size,listingPhoto,videoElement,headshot,address,addressLine2,beds,baths,sqft,price,agentName,phone,brokerage,logo,fontFamily,barColor,accentColor,brandShadow}:any){
  const w=size.width,h=size.height,isStory=size.id==="story",isPostcard=size.id==="postcard",unit=w/1080;
...
const TEMPLATES=[{id:"just-listed",label:"Just Listed",icon:Home,color:"#10b981"},{id:"open-house",label:"Open House",icon:Calendar,color:"#6366f1"},{id:"price-reduced",label:"Price Reduced",icon:DollarSign,color:"#f59e0b"},{id:"just-sold",label:"Just Sold",icon:CheckCircle,color:"#ef4444"},{id:"for-rent",label:"For Rent",icon:Home,color:"#16a34a"},{id:"magazine-cover",label:"Listed (Magazine)",icon:Home,color:"#0ea5e9"},{id:"magazine-rent",label:"Rent (Magazine)",icon:Home,color:"#16a34a"},{id:"split-diagonal",label:"Listed (Split)",icon:Home,color:"#8b5cf6"},{id:"split-rent",label:"Rent (Split)",icon:Home,color:"#16a34a"},{id:"stamp-listed",label:"Listed (Stamp)",icon:Home,color:"#14b8a6"},{id:"stamp-reduced",label:"Reduced (Stamp)",icon:DollarSign,color:"#f97316"},{id:"stamp-rent",label:"Rent (Stamp)",icon:Home,color:"#16a34a"},{id:"cinematic-listed",label:"Listed (Cinema)",icon:Home,color:"#6366f1"},{id:"cinematic-reduced",label:"Reduced (Cinema)",icon:DollarSign,color:"#e11d48"},{id:"cinematic-rent",label:"Rent (Cinema)",icon:Home,color:"#16a34a"},{id:"bold-frame",label:"Reduced (Frame)",icon:DollarSign,color:"#dc2626"},{id:"frame-rent",label:"Rent (Frame)",icon:Home,color:"#16a34a"}];
