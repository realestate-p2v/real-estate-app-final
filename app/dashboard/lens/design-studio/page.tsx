    ...
    try {
      ...
      if (hasMusic) {
        ...
        await ffmpeg.exec([
          ...
          "-filter_complex",
          [
            `[0:v]scale=${outW}:${outH}:force_original_aspect_ratio=increase,crop=${outW}:${outH}:0:0[bg]`,
        ...
        await ffmpeg.exec([
          ...
          "-i", "overlay.png",
          "-t", "45",
          "-filter_complex", `[0:v]scale=${outW}:${outH}:force_original_aspect_ratio=increase,crop=${outW}:${outH}:0:0[bg];[bg][1:v]overlay=0:0`,
          "-c:v", "libx264",
          "-preset", "fast",
          "-crf", "23",
          "-c:a", "aac",
