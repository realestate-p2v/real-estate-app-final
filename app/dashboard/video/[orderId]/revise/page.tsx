...
export default function RevisionPage() {
  ...
  const toggleRevise = (index: number) => {
    setClips(
      clips.map((c, i) =>
        i === index
          ? { ...c, action: c.action === "revise" ? "keep" : "revise" }
          : c
      )
    );
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-2xl px-4 py-20 text-center space-y-4">
          ...
          <h1 className="text-2xl font-bold text-foreground">Revision Submitted!</h1>
          <p className="text-muted-foreground">
            We've received your revision request and will process it within 24 hours.
            You'll receive an email when your updated video is ready.
          </p>
          <div className="flex gap-3 justify-center">
            <Button asChild>
              <Link href="/dashboard/videos">Back to My Videos</Link>
            </Button>
          </div>
        </div>
      </div>
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-2xl px-4 py-20 text-center space-y-4">
          ...
          <h1 className="text-2xl font-bold text-foreground">Clips Not Available</h1>
          <p className="text-muted-foreground">
            Individual clip data is not available for this order. This may be because it was processed before our clip preview feature was added.
            Please contact support to request a revision.
          </p>
          <Button asChild>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center gap-3 mb-6">
          <Link href="/dashboard/videos" className="text-muted-foreground hover:text-foreground">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              {isFree ? (
                <span className="text-green-600 font-semibold">{revisionsAllowed} free included</span>
              ) : (
                <span className="text-amber-600 font-semibold">paid revision</span>
              )}{" "}
              · ~24hr turnaround
            </p>
          </div>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 p-3">
                  ...
                  {/* Clip preview */}
                 <div className="w-56 h-[126px] sm:w-72 sm:h-[162px] rounded-lg overflow-hidden flex-shrink-0 bg-black relative">
                    {clip.file_id ? (
                      <iframe
        ...
        <div className="bg-card rounded-xl border border-border p-6 space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <div className="text-2xl font-black text-amber-600">{revisedClips.filter(c => c.action === "revise").length}</div>
              <div className="text-xs text-muted-foreground">Clips to revise</div>
            </div>
            <div>
