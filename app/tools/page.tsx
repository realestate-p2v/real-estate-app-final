...
const A: Record<AccentKey, AccentStyles> = {
  cyan: {
    ...
    gradFrom: "from-cyan-500/10", numOutline: "text-cyan-400/10", fill: "fill-cyan-400",
  },
  indigo: {
    ...
    gradFrom: "from-indigo-500/10", numOutline: "text-indigo-400/10", fill: "fill-indigo-400",
  },
  emerald: {
    ...
    gradFrom: "from-emerald-500/10", numOutline: "text-emerald-400/10", fill: "fill-emerald-400",
  },
  amber: {
    ...
    gradFrom: "from-amber-500/10", numOutline: "text-amber-400/10", fill: "fill-amber-400",
  },
  violet: {
    ...
    gradFrom: "from-violet-500/10", numOutline: "text-violet-400/10", fill: "fill-violet-400",
  },
  orange: {
    ...
    gradFrom: "from-orange-500/10", numOutline: "text-orange-400/10", fill: "fill-orange-400",
  },
  teal: {
    ...
    gradFrom: "from-teal-500/10", numOutline: "text-teal-400/10", fill: "fill-teal-400",
  },
  sky: {
    ...
    gradFrom: "from-sky-500/10", numOutline: "text-sky-400/10", fill: "fill-sky-400",
  },
  rose: {
    ...
    gradFrom: "from-rose-500/10", numOutline: "text-rose-400/10", fill: "fill-rose-400",
  },
  blue: {
    ...
    gradFrom: "from-blue-500/10", numOutline: "text-blue-400/10", fill: "fill-blue-400",
  },
};
...
function PhotoToVideoDemo() {
  ...
  const tiles = [
    ...
    "linear-gradient(135deg, #1e40af, #67e8f9)",
        ...
        {tiles.map((bg, i) => (
          <div
            ...
            style={{
              ...
              transition: `all 600ms cubic-bezier(0.34, 1.56, 0.64, 1) ${i * 80}ms`,
            }}
          >
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_40%,rgba(255,255,255,0.25),transparent_60%)]" />
            <div className="absolute right-2 top-2 h-1.5 w-1.5 rounded-full bg-white/40" />
          </div>
        ))}
      </div>
      ...
      >
        <div className="flex items-center gap-3 rounded-full bg-gray-950/90 px-5 py-2.5 ring-1 ring-cyan-400/40 backdrop-blur-md shadow-xl">
          ...
          <span className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider text-cyan-400">
            <Play className="h-3 w-3 fill-cyan-400" /> Cinematic Video
          </span>
        </div>
      </div>

      <div className="absolute bottom-4 left-4 right-4 overflow-hidden rounded-full bg-white/10">
        <div
          className="h-1 rounded-full bg-gradient-to-r from-cyan-400 to-sky-400"
          style={{
            width: inView ? "100%" : "0%",
