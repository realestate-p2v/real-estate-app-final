...
const SOCIAL_LINKS = [
  {
    name: "Instagram",
    href: "https://www.instagram.com/realestatephoto2video/",
    icon: (
  ...
  {
    name: "TikTok",
    href: "https://www.tiktok.com/@realestatephoto2video",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "YouTube",
    href: "https://www.youtube.com/@RealEstatePhoto2Video",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61587039633673",
    icon: (
      <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <footer className="bg-muted/50 border-t py-8 mt-12">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-4">
          ...
          <Link href="/resources/photography-guide" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Free Guide</Link>
          <Link href="/directory" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Photographer Directory</Link>
