...
export function OrderForm() {
  // 1. ORIGINAL STATE (Restored for compatibility)
  ...
  // 2. NEW FEATURES STATE (Listing URL & Instructions)
  ...
  // Validation logic: Must have photos (or URL), confirmed sequence (if manual), and music
  ...
  // 4. STRIPE & CLOUDINARY UPLOAD LOGIC
  ...
  const handleSubmitOrder = async () => {
    ...
    try {
      ...
      // Only upload if using manual photos
      if (!useUrl) {
          ...
          <div className="space-y-6">
            <div className="bg-card rounded-2xl border border-border p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-xl font-bold">Upload Photos or Provide URL</h2>
              </div>
              ...
              <PhotoUploader 
                ...
                setInstructions={setUrlInstructions}
              />
            </div>
